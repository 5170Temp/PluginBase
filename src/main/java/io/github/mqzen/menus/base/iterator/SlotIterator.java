...
public final class SlotIterator {
	...
	private final io.github.mqzen.menus.base.iterator.Direction direction;
	private final Slot endSlot;
	private @NotNull Slot current;
	
	SlotIterator(@NotNull Slot startingSlot, Slot endSlot, Capacity capacity, io.github.mqzen.menus.base.iterator.Direction direction) {
	...
	SlotIterator(Capacity capacity, io.github.mqzen.menus.base.iterator.Direction direction) {
	...
	public static SlotIterator create(Capacity capacity, io.github.mqzen.menus.base.iterator.Direction direction) {
		return new SlotIterator(capacity, direction);
	}
	
	public static SlotIterator create(Slot start, Capacity capacity, io.github.mqzen.menus.base.iterator.Direction direction) {
		return new SlotIterator(start, Slot.of(capacity.getTotalSize() - 1), capacity, direction);
	}
	
	public static SlotIterator create(Slot start, Slot end, Capacity capacity, io.github.mqzen.menus.base.iterator.Direction direction) {
