...
@Getter
@ApiStatus.Internal
public final class PageView extends BaseMenuView<io.github.mqzen.menus.base.pagination.Page> {
	
	private final io.github.mqzen.menus.base.pagination.Pagination pagination;
	private final int index;

	private Capacity capacity;

	PageView(io.github.mqzen.menus.base.pagination.Pagination pagination, io.github.mqzen.menus.base.pagination.Page creator, int index) {
