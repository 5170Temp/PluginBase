...
class PaginationImpl implements Pagination {
	...
	private final io.github.mqzen.menus.base.pagination.Page pageModel;
	private final List<io.github.mqzen.menus.base.pagination.PageComponent> components = Lists.newArrayList();
	...
	PaginationImpl(
		...
		boolean trimExtra,
		boolean automatic,
		io.github.mqzen.menus.base.pagination.Page pageModel
	) {
	 ...
	 */
	@Override
	public @NotNull io.github.mqzen.menus.base.pagination.Page getPageCreator() {
		return pageModel;
	}
	 ...
	 */
	@Override
	public List<io.github.mqzen.menus.base.pagination.PageComponent> getPageComponents() {
		return components;
	}
	 ...
	 */
	@Override
	public void addComponents(List<io.github.mqzen.menus.base.pagination.PageComponent> components) {
	...
	public synchronized void paginate(Player opener) {
		...
		for (int pageIndex = 0; pageIndex < maxPages; pageIndex++) {
			...
			for (int index = startIndex; index < endIndex; index++) {
				io.github.mqzen.menus.base.pagination.PageComponent component = getComponent(components, index);
	...
	private static io.github.mqzen.menus.base.pagination.PageComponent getComponent(List<PageComponent> components, int index) {
		try {
	 ...
	 */
	@Override
	public void setPage(int index, io.github.mqzen.menus.base.pagination.Page creator) {
		if (automatic)
