...
public interface Pagination {
	...
	static Builder.Automatic auto(Lotus manager) {
		return new Builder.Automatic(manager);
	}
	
	static Builder.Plain plain(Lotus manager) {
	 ...
	 */
	@NotNull io.github.mqzen.menus.base.pagination.Page getPageCreator();
	 ...
	 */
	List<io.github.mqzen.menus.base.pagination.PageComponent> getPageComponents();
	 ...
	 */
	void setComponentProvider(io.github.mqzen.menus.base.pagination.PageComponentsProvider provider);
	 ...
	 */
	void addComponents(List<io.github.mqzen.menus.base.pagination.PageComponent> components);
	 ...
	 */
	void setPage(int index, io.github.mqzen.menus.base.pagination.Page creator);
	 ...
	 * which is decided by {@link io.github.mqzen.menus.base.pagination.Page#getFillRange(Capacity, Player)}
	 */
	...
	abstract class Builder {
		...
		public static class Automatic extends Builder {
			...
			private final LinkedList<io.github.mqzen.menus.base.pagination.PageComponent> components = Lists.newLinkedList();
			private io.github.mqzen.menus.base.pagination.Page creator;
			private io.github.mqzen.menus.base.pagination.PageComponentsProvider provider;
			
			protected Automatic(Lotus manager) {
				super(manager, true);
			}
			
			public Automatic creator(io.github.mqzen.menus.base.pagination.Page creator) {
			...
			public Pagination build() {
				...
				io.github.mqzen.menus.base.pagination.PaginationImpl impl = new io.github.mqzen.menus.base.pagination.PaginationImpl(manager, trimExtra, auto, creator);
				if (provider != null)
		...
		public static class Plain extends Builder {
			...
			private final Map<Integer, io.github.mqzen.menus.base.pagination.Page> creators = new HashMap<>();
			...
			@Override
			public Pagination build() {
				io.github.mqzen.menus.base.pagination.PaginationImpl impl = new io.github.mqzen.menus.base.pagination.PaginationImpl(manager, trimExtra, auto, null);
