...
/**
 * A functional interface used to define whether a given {@link io.github.mqzen.menus.misc.button.Button} in a specific {@link Slot}
...
public interface ButtonCondition {
	...
	/**
	 * Determines whether a given {@link io.github.mqzen.menus.misc.button.Button} in a specific {@link Slot} satisfies certain conditions.
	 *
