...
final class Reflections {
     ...
     */
    public static <T> io.github.mqzen.menus.FieldAccessor<T> getField(Class<?> target, String name, Class<T> fieldType) {
     ...
     * @return The field accessor.
     */
    public static <T> io.github.mqzen.menus.FieldAccessor<T> getField(String className, String name, Class<T> fieldType) {
     ...
     * @return The field accessor.
     */
    public static <T> io.github.mqzen.menus.FieldAccessor<T> getField(Class<?> target, Class<T> fieldType) {
     ...
     * @return The field accessor.
     */
    public static <T> io.github.mqzen.menus.FieldAccessor<T> getField(Class<?> target, Class<T> fieldType, int index) {
     ...
     * @return The field accessor.
     */
    public static <T> io.github.mqzen.menus.FieldAccessor<T> getField(String className, Class<T> fieldType, int index) {
        return getField(getClass(className), fieldType, index);
    }

    private static <T> io.github.mqzen.menus.FieldAccessor<T> getField(
            final Class<?> target,
            final String name,
        ...
        for (final Field field : target.getDeclaredFields()) {
            if ((name == null || field.getName().equals(name)) && fieldType.isAssignableFrom(field.getType()) && index-- <= 0) {
                ...
                return new io.github.mqzen.menus.FieldAccessor<T>() {
